...
interface EnterpriseLanguageContent {
  links: Record<EnterprisePageKey, string>;
  pages: Record<EnterprisePageKey, EnterprisePageContent>;
}

const english: EnterpriseLanguageContent = {
  links: {
    security: 'Security',
...
export const enterprisePages: Record<Language, EnterpriseLanguageContent> = {
  en: english,
  tr: {
