...
const en: CyberHomeCopy = {
  seo: {
    ...
    description: 'Kernel Guard builds open-source cybersecurity infrastructure for compatibility assurance, runtime enforcement, and verifiable protection across modern Linux environments.',
  ...
  hero: {
    line1: 'Open-Source',
    line2: 'Cybersecurity Infrastructure',
  ...
  tech: {
    ...
    description: 'The systems technologies behind compatibility assurance, runtime enforcement, and open-source cybersecurity infrastructure.',
  },
  proof: {
...
const tr: CyberHomeCopy = {
  seo: {
    title: 'Kernel Guard | Açık Kaynak Siber Güvenlik Altyapısı',
    description: 'Kernel Guard; uyumluluk güvencesi, runtime enforcement ve doğrulanabilir koruma için açık kaynak siber güvenlik altyapısı geliştirir.',
  ...
  hero: {
    line1: 'Açık Kaynak',
    line2: 'Siber Güvenlik Altyapısı',
  ...
  tech: {
    ...
    description: 'Uyumluluk güvencesi, runtime enforcement ve açık kaynak siber güvenlik altyapısının arkasındaki sistem teknolojileri.',
  },
  proof: {
...
const de = derived({
  seo: { title: 'Kernel Guard | Open-Source-Cybersecurity-Infrastruktur', description: 'Kernel Guard entwickelt Open-Source-Cybersecurity-Infrastruktur für Kompatibilitätssicherheit, Runtime-Enforcement und verifizierbaren Schutz.', keywords: en.seo.keywords },
  hero: { line1: 'Open Source', line2: 'Cybersecurity-Infrastruktur', description: 'Kompatibilität vor dem Deployment. Runtime-Enforcement danach. Verifizierbare Sicherheitsinfrastruktur für moderne Systeme.' },
  ...
  tech: { title: 'Security-Engineering-Stack', description: 'Systemtechnologien hinter Kompatibilitätssicherheit, Runtime-Enforcement und Open-Source-Cybersecurity.' },
...
const ja = derived({
  seo: { title: 'Kernel Guard | オープンソース・サイバーセキュリティ基盤', description: 'Kernel Guard は互換性保証、ランタイム enforcement、検証可能な保護のためのオープンソース・サイバーセキュリティ基盤を開発します。', keywords: en.seo.keywords },
  hero: { line1: 'オープンソース', line2: 'サイバーセキュリティ基盤', description: 'デプロイ前の互換性保証。デプロイ後の runtime enforcement。現代のシステム向けの検証可能なセキュリティ基盤。' },
  ...
  tech: { title: 'セキュリティ・エンジニアリング・スタック', description: '互換性保証、runtime enforcement、オープンソース・サイバーセキュリティを支えるシステム技術。' },
...
const zhCN = derived({
  seo: { title: 'Kernel Guard | 开源网络安全基础设施', description: 'Kernel Guard 构建面向兼容性保障、运行时策略执行和可验证保护的开源网络安全基础设施。', keywords: en.seo.keywords },
  hero: { line1: '开源', line2: '网络安全基础设施', description: '部署前兼容性保障。部署后运行时策略执行。面向现代系统的可验证安全基础设施。' },
  ...
  tech: { title: '安全工程技术栈', description: '支撑兼容性保障、runtime enforcement 和开源网络安全基础设施的系统技术。' },
...
const es = derived({
  seo: { title: 'Kernel Guard | Infraestructura de ciberseguridad open source', description: 'Kernel Guard desarrolla infraestructura de ciberseguridad open source para assurance de compatibilidad, enforcement runtime y protección verificable.', keywords: en.seo.keywords },
  hero: { line1: 'Open Source', line2: 'Infraestructura de Ciberseguridad', description: 'Compatibility assurance antes del despliegue. Enforcement runtime después. Infraestructura de seguridad verificable para sistemas modernos.' },
  ...
  tech: { title: 'Stack de ingeniería de seguridad', description: 'Tecnologías de sistemas detrás de compatibility assurance, runtime enforcement y ciberseguridad open source.' },
...
const fr = derived({
  seo: { title: 'Kernel Guard | Infrastructure de cybersécurité open source', description: 'Kernel Guard développe une infrastructure de cybersécurité open source pour l’assurance de compatibilité, l’enforcement runtime et une protection vérifiable.', keywords: en.seo.keywords },
  hero: { line1: 'Open Source', line2: 'Infrastructure de Cybersécurité', description: 'Assurance de compatibilité avant déploiement. Enforcement runtime après. Infrastructure de sécurité vérifiable pour les systèmes modernes.' },
  ...
  tech: { title: 'Stack d’ingénierie sécurité', description: 'Technologies systèmes derrière compatibility assurance, runtime enforcement et cybersécurité open source.' },
...
const ko = derived({
  seo: { title: 'Kernel Guard | 오픈소스 사이버보안 인프라', description: 'Kernel Guard는 호환성 보장, 런타임 정책 집행, 검증 가능한 보호를 위한 오픈소스 사이버보안 인프라를 구축합니다.', keywords: en.seo.keywords },
  hero: { line1: '오픈소스', line2: '사이버보안 인프라', description: '배포 전 호환성 보장. 배포 후 runtime enforcement. 현대 시스템을 위한 검증 가능한 보안 인프라.' },
  ...
  tech: { title: '보안 엔지니어링 스택', description: '호환성 보장, runtime enforcement, 오픈소스 사이버보안을 구성하는 시스템 기술.' },
